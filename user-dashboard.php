      ...
      <div class="glass-card loan-overview">
        ...
        <?php else: ?>
          <div style="text-align: center; padding: 2rem;">
            ...
            <a href="loan_application_form.html" class="btn btn-primary" style="margin-top: 1rem;">
      ...
      <div class="glass-card full-width">
        ...
        <div class="services-grid">
          <div class="service-card">
            ...
            <a href="loan_application_form.html" class="btn btn-primary">
    ...
    function showComingSoon() {
      ...
      modal.innerHTML = `
        <div class="coming-soon-modal">
          ...
          <h3>Coming Soon!</h3>
          <p style="margin: 1rem 0; color: var(--text-secondary);">This feature is under development. Stay tuned for updates!</p>
          <button onclick="closeComingSoon()" class="btn btn-primary">
            <i class="fas fa-check"></i> Got it
          </button>
        </div>
        <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
                    background: rgba(0,0,0,0.5); z-index: 1000;" onclick="closeComingSoon()"></div>
      `;
